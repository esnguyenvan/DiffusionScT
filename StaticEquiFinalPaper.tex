...
The problem being now defined, the next section will treat the constitution od the aerodynamic database to compute the aerodynamic coefficients in function of VT area as well as flight phase.
